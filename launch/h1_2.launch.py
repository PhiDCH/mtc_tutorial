...
def generate_launch_description():
    moveit_config = (
        MoveItConfigsBuilder(
            robot_name="h1", package_name="vr_h1_2_moveit_config"
        )
        .robot_description(file_path="config/h1_2_handless.urdf.xacro")
    ...
    static_tf = Node(
        ...
        arguments=["--frame-id", "world", "--child-frame-id", "pelvis"],
    )
